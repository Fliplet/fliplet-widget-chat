...
this["Fliplet"]["Widget"]["Templates"]["templates.conversation-content"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"offline-note\">"
    ...
    + alias3((helpers.T || (depth0 && depth0.T) || alias2).call(alias1,"widgets.chat.conversation.actions.loadMore",{"name":"T","hash":{},"data":data}))
    ...
    + alias3((helpers.T || (depth0 && depth0.T) || alias2).call(alias1,"widgets.chat.conversation.sendTo",{"name":"T","hash":{},"data":data}))
    ...
    + alias3((helpers.T || (depth0 && depth0.T) || alias2).call(alias1,"widgets.chat.conversation.actions.send",{"name":"T","hash":{},"data":data}))
...
this["Fliplet"]["Widget"]["Templates"]["templates.group-tabs"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<section class=\"tab-group\">\n  <label class=\"tab\">\n    <input type=\"radio\" name=\"group-tabs\" value=\"\" checked=\"checked\" />\n    <span class=\"control-label\">"
    + alias3((helpers.T || (depth0 && depth0.T) || alias2).call(alias1,"widgets.chat.tabs.directMessages",{"name":"T","hash":{},"data":data}))
    + "</span>\n  </label>\n  <label class=\"tab\">\n    <input type=\"radio\" name=\"group-tabs\" value=\"1\" />\n    <span class=\"control-label\">"
    + alias3((helpers.T || (depth0 && depth0.T) || alias2).call(alias1,"widgets.chat.tabs.publicChannels",{"name":"T","hash":{},"data":data}))
    + "</span>\n  </label>\n</section>\n";
},"useData":true});
